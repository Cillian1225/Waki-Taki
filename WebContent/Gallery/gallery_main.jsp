	...
	<c:choose>
       <c:when test="${login.id==null}">
		<div class="container-fluid p-0" id="navibar">
         <div class="row m-0">
            <div class="col-12 col-lg-3 col-xl-2 p-0"><a href="beforeLogin.gal?cpage=1"><img src="project_logo.jpg"></a></div>
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="#">산책장소</a></div>
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="#">팻시터</a></div>
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="galList.gal?cpage=1">갤러리</a></div>
            <div class="col-3 col-lg-3 col-xl-1 p-0 navitext"><a href="#">자유게시판</a></div>
            ...
            <div class="col-6 col-lg-4 col-xl-1 p-0 navitext" id="mypage"><a href="#">회원가입</a></div>
            <div class="col-6 col-lg-4 col-xl-1 p-0 navitext"><a href="#">로그인</a></div>
         </div> 
    	</div>
    	</c:when>
    	...
    	<div class="container-fluid p-0" id="navibar">
         <div class="row m-0">
            ...
            <div class="col-12 col-lg-3 col-xl-2 p-0"><a href="afterLogin.gal?cpage=1"><img src="project_logo.jpg"></a></div>
       
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="#">산책장소</a></div>
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="#">팻시터</a></div>
            <div class="col-3 col-lg-2 col-xl-1 p-0 navitext"><a href="beforeLogin.gal?cpage=1">갤러리</a></div>
            <div class="col-3 col-lg-3 col-xl-1 p-0 navitext"><a href="#">자유게시판</a></div>
            <div class="col-12 col-lg-4 col-xl-4 p-0">
                <img src="search.png" id="searchImg">
                <input type="text" placeholder="원하는구,장소를 검색하세요." class="form-control me-2 ml-3" id="search">
            </div>
            <div class="col-6 col-lg-4 col-xl-1 p-0 navitext" id="mypage"><a href="#">마이페이지</a></div>
            <div class="col-6 col-lg-4 col-xl-1 p-0 navitext"><a href="#">로그아웃</a></div>
         </div> 
    	</div>
