            	...
            	$.ajax({ 
					url:"check.message",
     				...
     				if(resp == 'true'){
     					...
     					location.href = "${pageContext.request.contextPath}/detailWrite.pet?seq=" + $(this).siblings(".pb_seq").val();
     				}
     			})
            })
     				...
     				if(resp == 'true'){
     					...
     					if(confirm("이 일정을 수락 하시겠습니까?")){
     	            		 $.ajax({ 
     	 	           			url:"accept.message",
     	 	        			type:"get",
     	 	        			data:{"seq":$(this).siblings(".seq").val(),"pb_seq":$(this).siblings(".pb_seq").val(),
     	 	        				"other_id":$(this).parents("#box").find("#other_id").val()}
     	         			}).done(function(resp){
     	             			if(resp == "1"){
...
<body>
    <div class="container-fluid p-0" id="navibar">
        <div class="row m-0">
            <div class="col-12 col-lg-3 col-xl-2 p-0"><img src="${pageContext.request.contextPath}/img/logo.jpg"></div>
