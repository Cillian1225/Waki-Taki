...
<body>
    <div class="container-fluid p-0" id="navibar">
        <div class="row m-0">
            <div class="col-12 col-lg-3 col-xl-2 p-0">	<a href="main.jsp"><img src="project_logo.jpg"></a></div>
            ...
            <c:choose>
            	<c:when test="${login==null}">
            		<div class="col-6 col-lg-4 col-xl-1 p-0 navitext" id="mypage"><a href="Signup/login.jsp">로그인</a></div>
    ...
    <div class="container rounded p-4 pt-5" id="bottomContainer">
        <div class="menu p-2">
            <div class="row m-0" style="height:100%">
                <div class="col-4 p-2">
                    <a href="history.planner">
                        <h5 class="title m-0">우리동네 플래너</h5>
                    </a>
                </div>
                <div class="col-4 p-2">
                    <a href="list.message">
            ...
            <div class="row m-0" style="height:100%"> 
                ...
                <div class="col-4 p-2">
                  ...
                  <a href="${pageContext.request.contextPath}/doginfomodify.dog"><h5 class="title m-0">강아지 정보수정</h5></a>
                    
                </div>
                <div class="col-4 p-2">
                <a href="${pageContext.request.contextPath}/doginfo.dog"><h5 class="title m-0">강아지정보 추가</h5></a> 
                </div>
            </div>
        </div>
    </div>
